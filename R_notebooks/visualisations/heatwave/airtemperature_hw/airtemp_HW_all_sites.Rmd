...
```{r}
png("/Users/teodorica/Downloads/papr/R/atmosfr/hw/allsites_airtemp_hw.png", width = 7, height = 5, units = "in",
...
plot(0, 0, type = "n",
     ...
     xlab = "Hour After Sunset", ylab = "Air Temperature (°C)",
...
legend("topright", 
       legend = c(expression(bold("Parks/Rural:")), "SEEP (Park A)", "FRIE (Park B)", "STGA (Park C)", "HOCH (Rural Site)", "",
                  expression(bold("Built-up Areas:")), "BETZ", "MESS", "UNIK", "INST", "KART"),
       col = c(NA, cornflowerblue_color, darksalmon_color, darkgreen_color, green3_color,
               NA, NA, cornflowerblue_transparent, 
               darksalmon_transparent, darksalmon_transparent, darkgreen_transparent, darkgreen_transparent),
