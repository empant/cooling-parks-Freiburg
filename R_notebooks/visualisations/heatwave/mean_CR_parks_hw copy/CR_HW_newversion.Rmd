...
plot_cooling_rates <- function(FRSTGA_data, FRHOCH_data, FRFRIE_data, FRSEEP_data, 
  ...
  point_types <- c(16,16,16,16)  # Different point shapes
  ...
  mtext(expression(paste("Cooling Rate (K/h)")),    # Cooling Rate (°C/h)
        side = 2, line = 3.2, cex = 1.1)
  
  legend("topright", 
         legend = c("SEEP (Park A)", "FRIE (Park B)", "STGA (Park C)", "HOCH (Rural Site)"),
         col = c("cornflowerblue", "darksalmon", "darkgreen", "green3"), 
         pch = 16,
         lwd = 2, 
         pt.cex = 1.2,
         bty = "o",
...
the actual plotting
```{r}
png("/Users/teodorica/Downloads/papr/R/atmosfr/hw/mean_CR_parks/CR_hw_parksrural_averaged.png", width = 7, height = 5, units = "in",
